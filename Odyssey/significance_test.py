...
# Data from Table R1 and Table R2
data = {
    "Table R1": {
...
def main():
    analyze_table_r1(data["Table R1"])
    analyze_table_r2(data["Table R2"])
    analyze_table_r3(data["Table R3"])
    analyze_table_r4(data["Table R4"])
