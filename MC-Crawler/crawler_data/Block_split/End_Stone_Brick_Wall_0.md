...
An end stone brick wall is a end stone brick variant of a wall.
...
### Note blocks
End stone brick walls can be placed under note blocks to produce "bass drum" sounds.
...
|----------------------|----------------------|--------------|------------|-----------|--------------------------------------|
| End Stone Brick Wall | end_stone_brick_wall | Block & Item | walls      | walls     | block.minecraft.end_stone_brick_wall |

Bedrock Edition:

| Name                 | Identifier       | Numeric ID | Form                       | Item ID[i 1]   | Translation key                      |
|----------------------|------------------|------------|----------------------------|----------------|--------------------------------------|
| End Stone Brick Wall | cobblestone_wall | 139        | Block & Giveable Item[i 2] | Identical[i 3] | tile.cobblestone_wall.end_brick.name |
