...
## Usage
### Food
To eat steak, press and hold use while it is selected in the hotbar. Eating one restores 8 () hunger and 12.8 hunger 
saturation. 
...
|-------|---------------|------|------------------------------|
| Steak | `cooked_beef` | Item | `item.minecraft.cooked_beef` |

Bedrock Edition:

| Name        | Identifier    | Numeric ID | Form | Translation key         |
|-------------|---------------|------------|------|-------------------------|
| Cooked Beef | `cooked_beef` | `274`      | Item | `item.cooked_beef.name` |
