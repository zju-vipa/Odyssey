# Tutorials/Digital minecart storage system
...
The whole system is modular and can be build as big as you want it to and the digital storage itself, also can be in a big distance. But more modules and a bigger distance will cause longer times to actually get the items from the storage and to the storage. A single module of this useful mechanism is 19×18×1 large.
...
Please help improve this page. The talk page may contain suggestions.Reason: The screenshots should use default textures (MCW:IMAGES), sections should be added
