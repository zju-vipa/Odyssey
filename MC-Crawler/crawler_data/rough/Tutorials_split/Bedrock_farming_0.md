# Tutorials/Bedrock farming
Bedrock farming is a method of using glitches, mainly with an end gateway portal or the bedrock portal frame in the End, to obtain bedrock blocks in Survival mode without commands or cheating.

## Contents
- 1 Working designs
- 2 Outdated designs
	- 2.1 Rays Works's design
	- 2.2 JC Playz's design
	- 2.3 Silent Whisper's design

## Working designs
SB737 made a bedrock farm in 1.20 but he also used another version
...
This farm can only be used once, and once you construct this farm you will be stuck in the End unless you die or explode the end crystals used in this farm, which will break it. Use at your own risk.
...
As of 1.19.70 this farm is broken, end crystal fire can't delete bedrock anymore.





This farm was initially designed by Cmax3010 and later updated by SilentWisperer

Here's Cmax3010's original video.
