# Prismarine Slab
A prismarine slab is a prismarine variant of a slab.
...
## Obtaining
### Breaking
Prismarine slabs can be mined using any pickaxe.
...
### Note blocks
Prismarine slabs can be placed under note blocks to produce "bass drum" sounds.
...
|-----------------|-------------------|--------------|--------------------------------|-----------|-----------------------------------|
| Prismarine Slab | `prismarine_slab` | Block & Item | `slabs`<br/>`mineable/pickaxe` | `slabs`   | `block.minecraft.prismarine_slab` |

Bedrock Edition:

| Name                   | Identifier                 | Alias ID             | Numeric ID | Form                         | Item ID[i 1]                                                      | Translation key                          |
|------------------------|----------------------------|----------------------|------------|------------------------------|-------------------------------------------------------------------|------------------------------------------|
| Double Prismarine Slab | `double_stone_block_slab2` | `double_stone_slab2` | `181`      | Block & Ungiveable Item[i 2] | `double_stone_block_slab2`<br/>Alias ID:`real_double_stone_slab2` | —                                        |
| Prismarine Slab        | `stone_block_slab2`        | `stone_slab2`        | `182`      | Block & Giveable Item[i 3]   | `stone_block_slab2`<br/>Alias ID:`double_stone_slab2`             | `tile.stone_slab2.prismarine.rough.name` |
