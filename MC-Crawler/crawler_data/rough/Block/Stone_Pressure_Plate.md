...
|----------------------|------------------------|--------------|------------------------------------------------------------------------|-----------|----------------------------------------|
| Stone Pressure Plate | `stone_pressure_plate` | Block & Item | `pressure_plates`<br/>`stone_pressure_plates`<br/>`wall_post_override` | None      | `block.minecraft.stone_pressure_plate` |
