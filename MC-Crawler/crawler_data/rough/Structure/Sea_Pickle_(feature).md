# Sea Pickle (feature)
Sea pickle is a feature that places sea pickles in the warm ocean biome.
...
| Feature             | Identifier       |
|---------------------|------------------|
| [No displayed name] | `pickle_feature` |
...
- config
	- countValue between 0 and 256 (inclusive). The max count of the sea pickle block (not single sea pickle).
		- 
		- Int provider
...
- Naturally generated Sea Pickles.
- Ditto
