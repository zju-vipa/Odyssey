# Seagrass (feature)
Seagrass is a feature that places seagrass in various underwater biomes.
...
|---------------------|------------|
| [No displayed name] | `seagrass` |

| Configured feature  | Identifier                     |
|---------------------|--------------------------------|
| [No displayed name] | `seagrass_mid`                 |
| [No displayed name] | `seagrass_short`               |
| [No displayed name] | `seagrass_simple`              |
| [No displayed name] | `seagrass_slightly_less_short` |
| [No displayed name] | `seagrass_tall`                |

Bedrock Edition:

| Feature             | Identifier         |
|---------------------|--------------------|
| [No displayed name] | `seagrass_feature` |
...
- 
	- probabilityValue between 0.0 and 1.0 (inclusive). Probability of using tall seagrass instead of seagrass
