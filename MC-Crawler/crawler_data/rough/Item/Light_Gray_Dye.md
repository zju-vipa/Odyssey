...
| Light GrayBannerimage         | Light Gray Dye+<br/>Banner+<br/>Vinesor<br/>Bricksor<br/>Creeper Heador<br/>Wither Skeleton Skullor<br/>Oxeye Daisyor<br/>Enchanted Golden Apple |                 |                                                                                                                                                                                             |

### Loom ingredient
| Name                    | Ingredients                                          | Loom recipe | Description                                                                                          |
|-------------------------|------------------------------------------------------|-------------|------------------------------------------------------------------------------------------------------|
| Light GrayBannerpattern | White Banner+<br/>Light Gray Dye                     |             | Field masoned banner and bordure indented banner don't require banner patterns.‌[Java Edition  only] |
| Light GrayBannerimage   | White Banner+<br/>Light Gray Dye+<br/>Banner Pattern |             | Exceptions:Field masoned and bordure indented banner patterns.‌[Bedrock Edition  only]<br/>          |
...
|----------------|------------------|------|---------------------------------|
| Light Gray Dye | `light_gray_dye` | Item | `item.minecraft.light_gray_dye` |

Bedrock Edition:

| Name           | Identifier       | Alias ID  | Numeric ID | Form | Translation key        |
|----------------|------------------|-----------|------------|------|------------------------|
| Light Gray Dye | `light_gray_dye` | `dye / 7` | `402`      | Item | `item.dye.silver.name` |

## Notes
1. ↑Known as Light Grey Dye in British, Canadian, Australian, and New Zealand English variants.
