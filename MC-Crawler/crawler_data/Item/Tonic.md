...
|-----------|---------------|----------------|------------------------------------------------------------------------------|
| Antidote  |               | CuresPoison    | Silver detects poisonin folklore, and possesses anti-microbial properties.   |
| Elixir    |               | CuresWeakness  |                                                                              |
| Eye Drops |               | CuresBlindness | Eye drops in real life should be dripped to the eyes instead of being drunk. |
| Tonic     |               | CuresNausea    | In real life,bismuth subsalicylateis used as a nausea treatment.             |
...
|----------|------------|------------|------|-----------------------------------------------------------------------------------------------------------|
| Medicine | medicine   | 599        | Item | item.medicine.poison.nameitem.medicine.weakness.nameitem.medicine.blindness.nameitem.medicine.nausea.name |
